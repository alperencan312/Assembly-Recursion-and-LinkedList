...
T10:
	bne $s1,10, T10no	# if s1 = 8, do these things. Else go to T8no
...
#	result->item = ptr->item;
#	
#	if( !ptr->next ){
#		result->next = dup( ptr->next );
#		return result;
#	}
#	else
#		return result;
...
msg118:  .asciiz "10 - exit this program \n"
...
msg133:	.asciiz "7 - deleteAfter_x. \n"

msg134:	.asciiz "X: "

msg135: .asciiz "8 - duplicateListIterative. \n"

msg136: .asciiz "9 - duplicateListRecursive. \n"
